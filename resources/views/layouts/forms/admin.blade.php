<h2 class="text-base md:text-4xl font-semibold">{{ $edit ? 'Editar' : 'Cadastro de' }} admnistrador</h2>
<form class="form-main" action="{{ $edit ? route('editAdmin', $edit) : route('saveAdmin') }}" method="post"
